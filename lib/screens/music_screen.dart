    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Row(
            children: [
              SizedBox(width: rs.isRecord ? size.width * 0.22 : size.width * 0.27),
              if(rs.isRecord) const Icon(Icons.radio_button_checked_rounded, color: Colors.red),
              const SizedBox(width: 3),
              Text(dm.currentSecond),
            ],
          ),
