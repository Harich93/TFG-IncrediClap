...
class PlayerScreen extends StatelessWidget {
  ...
  PlayerScreen({Key? key, this.audioRecord}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
        ...
        child: Scaffold(
            ...
            body: HomeBackground(
              child: Column(
                children: [ImagenDiscoDuracion(), TituloPlay()],
              ),
            )));
  }
}
...
class _TituloPlayState extends State<TituloPlay>
  ...
  void initState() {
    ...
    playAnimation =
        AnimationController(vsync: this, duration: playerAudio.lastDuration);
    super.initState();
  }
                          ...
                          Text(playerAudio.title,
                              ...
                              style: TextStyle(
                                  ...
                                  color: ThemeColors.darkPrimary
                                      .withOpacity(0.8))),
                          Text('Creado por: ${playerAudio.userName}',
                              style: TextStyle(
...
class ImagenDisco extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Duration discAnimaDuration =
        rs.selectedAudioRecord.tracks.last.parseDuration();
